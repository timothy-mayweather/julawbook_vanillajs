/**The create, read, update and delete functions of a crud table/form */
class CRUD{
...
class TableUISection{
  ...
  addTabDiv(txt=null,context=this.context){
    return '<div style="margin-bottom:5px">'+ this.addBtn(txt,context)+
      '<table id="add'+context+'Table" class="table table-bordered table-hover table-responsive form-table '+this.tabClass+'" hidden></table></div>';
  }
  editTabDiv(txt=null,context=this.context){
    return '<div style="margin-bottom:5px">'+this.editBtn(txt,context)+this.editStateBtn(context)+this.reloadBtn(context)+'<div style="margin-top:5px">'+
      '<table id="edit'+context+'Table" class="table table-bordered table-hover table-striped form-table '+this.tabClass+'" style="margin-top:5px" hidden></table></div></div>';
  }
  accTabDiv(tabId,txt){
    ...
    return  '<div style="margin-bottom:5px">'+this.outlineBtn+'primary" id="edit'+tabId+'Btn" clicked="0">View Or Edit '+txt+'</button>'+this.outlineBtn+
      ...
      '<table id="'+tabId[0].toLowerCase()+tabId.slice(1)+'Table" class="table table-bordered table-hover table-striped form-table '+this.tabClass+'" style="margin-top:5px" hidden></table></div></div>';
  }
